...
```
## 📌 Project Highlights
- Built a complete Spark SQL data analysis pipeline
- Applied real-world big data techniques
- Used window functions and pivot operations
- Processed structured IoT data efficiently
